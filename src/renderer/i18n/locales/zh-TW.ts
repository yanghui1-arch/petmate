...
export default {
  ...
  schoolHandbook: {
    ...
    batchTab: '學期手冊',
    batchTitle: '尤美的本批小目標',
    batchCompleteTitle: '這一批完成啦',
    batchCompleteDescription: '印章已經記下，下一批任務會在倒數結束後自動出現。',
    allTaskRequired: '本批 3 個任務需要全部完成，才會獲得印章。',
    tasksComplete: '已完成',
    cooldownTitle: '下一批任務倒數',
    stampHintComplete: '本批已蓋章，等待下一批',
    stampHintAll: '完成全部 3 項即可蓋章',
    oneTimeTask: '完成 1 次',
    rewardsTab: '印章獎勵',
    ruleRefreshDescription: '批次完成後進入冷卻，倒數結束會自動刷新下一批。',
    ruleOfflineDescription: '計時保存在本地，退出應用程式或電腦休眠都不會暫停刷新時間。',
    ruleStampDescription: '印章會持續獲得；開學補給箱和開學限定物品各需 1 枚印章，可重複兌換；稱謂需 3 枚，套裝需 5 枚，各限兌換 1 次。',
    rulesTitle: '蓋章規則',
    rules: '每批會出現 3 個隨機小目標，全部完成後獲得 1 枚印章；2 小時後刷新下一批，離線也有效。',
    loading: '正在翻開手冊…',
    loadFailed: '手冊暫時無法開啟',
    retry: '再試一次',
    ...
    repeatable: '可重複兌換',
    oneTimeOnly: '限兌 1 次',
    rewardEarnedKicker: '新學期獎勵',
    rewardEarnedTitle: '恭喜獲得',
    rewardEarnedClose: '收下獎勵',
    rewardNew: '新',
    rewardSupplyBoxReceived: '獲得開學補給箱',
    rewardLimitedItemReceived: '獲得開學限定物品',
    rewardSupplyBoxHint: '已放入背包「其他」分類，點擊使用即可開啟。',
    rewardConfirmTitle: '確認兌換',
    rewardQuantity: '兌換數量',
    rewardQuantityLimit: '最多 {count} 個',
    rewardTotalCost: '合計 {count} 枚印章',
    rewardBatchCount: '已兌換 {count} 個',
  },
  chat: {
  ...
  item: {
    confirm: '確定', cancel: '取消', buyFashion: '確認購買此時裝', purchasedGain: '購買後獲得', usedGain: '使用後獲得以下效果', purpose: '用途', permanentUnlock: '永久解鎖，可前往衣櫥實裝', cannotUse: '不能在背包中直接使用', noEffect: '無', useCountZero: '使用物品數量不能為0', buyCountZero: '購買物品數量不能為0', buySuccess: '購買成功', buyFailed: '購買失敗', useSuccess: '使用成功', useFailed: '使用失敗', requirement: '要求', source: '獲得方式', blackMarket: '黑市', activity: '活動', supplyBoxRewardKicker: '開箱獎勵', supplyBoxRewardTitle: '補給箱開啟成功', supplyBoxRewardDescription: '這是本次開學補給箱獲得的物品。', supplyBoxRewardClose: '收下物品', supplyBoxCash: '金幣', limitedItemRewardKicker: '限定獎勵', limitedItemRewardTitle: '開學限定物品開啟成功', limitedItemRewardDescription: '這是本次開學限定物品獲得的委託道具。', limitedItemRewardClose: '收下物品',
  },
  buff: {
