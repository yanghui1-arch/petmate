...
export default {
  ...
  schoolHandbook: {
    ...
    batchTab: 'Semester handbook',
    batchTitle: "Youmei's mini-goals",
    batchCompleteTitle: 'Batch complete',
    batchCompleteDescription: 'Your stamp is recorded. The next batch appears when the cooldown ends.',
    allTaskRequired: 'Complete all 3 tasks in this batch to earn its stamp.',
    tasksComplete: 'complete',
    cooldownTitle: 'Next batch in',
    stampHintComplete: 'Stamped — waiting for the next batch',
    stampHintAll: 'Complete all 3 tasks to stamp',
    oneTimeTask: '1 completion',
    rewardsTab: 'Stamp rewards',
    ruleRefreshDescription: 'A completed batch enters cooldown and automatically refreshes when the timer ends.',
    ruleOfflineDescription: 'The timestamp is saved locally, so closing the app or sleeping the computer does not pause it.',
    ruleStampDescription: 'Stamps keep coming: the supply box and limited item cost 1 stamp each and can be repeated; the title costs 3 stamps and the set costs 5, each one-time only.',
    rulesTitle: 'Stamp rules',
    rules: 'Each batch gives you 3 random mini-goals. Complete all 3 for a stamp, then wait 2 hours for the next batch — offline time counts.',
    ...
    oneTimeOnly: 'One-time',
    rewardEarnedKicker: 'NEW-TERM REWARD',
    rewardEarnedTitle: 'Congratulations!',
    rewardEarnedClose: 'Collect reward',
    rewardNew: 'NEW',
    rewardSupplyBoxReceived: 'Received: New-term supply box',
    rewardLimitedItemReceived: 'Received: New-term limited item',
    rewardSupplyBoxHint: 'Added to Backpack → Other. Click it there to open the box.',
    rewardConfirmTitle: 'Confirm exchange',
    rewardQuantity: 'Quantity',
    rewardQuantityLimit: 'Up to {count}',
    rewardTotalCost: '{count} stamps total',
    rewardBatchCount: '{count} redeemed',
  },
  chat: {
  ...
  item: {
    confirm: 'Confirm', cancel: 'Cancel', buyFashion: 'Confirm purchase of this outfit', purchasedGain: 'Granted after purchase', usedGain: 'Effects gained after use', purpose: 'Purpose', permanentUnlock: 'Permanently unlocked; equip it from the wardrobe', cannotUse: 'This item cannot be used directly from the package', noEffect: 'None', useCountZero: 'The use quantity cannot be 0', buyCountZero: 'The purchase quantity cannot be 0', buySuccess: 'Purchase successful', buyFailed: 'Purchase failed', useSuccess: 'Item used', useFailed: 'Item use failed', requirement: 'Requirements', source: 'Source', blackMarket: 'Black market', activity: 'Activity', supplyBoxRewardKicker: 'BOX OPENED', supplyBoxRewardTitle: 'Supply box opened', supplyBoxRewardDescription: 'Here is everything found in this new-term supply box.', supplyBoxRewardClose: 'Collect items', supplyBoxCash: 'Coins', limitedItemRewardKicker: 'LIMITED REWARD', limitedItemRewardTitle: 'Limited item opened', limitedItemRewardDescription: 'Here is the commission item found in this new-term limited reward.', limitedItemRewardClose: 'Collect item',
  },
  buff: {
